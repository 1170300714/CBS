...
class CoOp_miniImageNet_wo_Base_Our_ACIL_Distribution(TrainerX):
    ...
    def build_data_loader(self):
        ...
        train_loader = torch.utils.data.DataLoader(train_set_task0,batch_size=20,num_workers=4,drop_last=False,shuffle=True)
