...
class Flower102(TorchDataset):
    ...
    def __init__(self, tfm,task_id,mode,class_per_task) -> None:
        ...
        image_root = "data/Flowers102/jpg"

        split_file_path = "data/Flowers102/split_zhou_OxfordFlowers.json"
        ...
        if mode=='train':
            ...
            for point in train_data:
                ...
                if class_id in select_class_id:
                    self.images_list.append(os.path.join(image_root, image_name))
...
class CoOp_Flowers_wo_Base_Our_ACIL_Exist_AL(TrainerX):
    ...
    def build_data_loader(self):
        ...
        train_set_task0 = Flower102(tfm=self.tfm_train,class_per_task=20,task_id = task_id_now,mode='train')
        ...
        test_set_task0 = Flower102(tfm=self.tfm_test,class_per_task=20,task_id = task_id_now,mode='test')
    ...
    def after_epoch(self):
        ...
        if do_test and self.cfg.TEST.FINAL_MODEL == "best_val" and self.epoch%10==0:
