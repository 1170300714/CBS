...
class MiniImageNet_CL(TorchDataset):
    ...
    def __init__(self,tfm,task_id,mode,class_per_task):
...
class CoOp_miniImageNet_wo_Base_Our_ACIL_Random(TrainerX):
    ...
    def build_data_loader(self):
        ...
        train_set_task0 = MiniImageNet_CL(tfm=self.tfm_train,class_per_task=20, task_id = task_id_now,mode='train')
        ...
        test_set_task0 = MiniImageNet_CL(tfm=self.tfm_test,class_per_task=20,task_id = task_id_now,mode='test')
